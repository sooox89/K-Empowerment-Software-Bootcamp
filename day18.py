...
## 전역 변수 선언 부분 ##
G1 = None
stack = [] 			# append() as push() and built in pop()
...
G1.graph[E][A] = 1; G1.graph[E][C] = 1; G1.graph[E][F] = 1; G1.graph[E][H] = 1
G1.graph[F][C] = 1
G1.graph[G][D] = 1; G1.graph[G][I] = 1
G1.graph[H][D] = 1; G1.graph[H][I] = 1
G1.graph[I][F] = 1; G1.graph[I][H] = 1
print('## G1 무방향 그래프 ##')
for row in range(9) :
	for col in range(9) :
